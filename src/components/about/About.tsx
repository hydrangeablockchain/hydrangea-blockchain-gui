...
const url = 'https://http://hydrangea.website/';
  ...
  return (
    <html>
      ...
      <body>
        ...
        <Spacer />
        <div className="copyright">Copyright (c) 2021 Hydrangea Network</div>
        <Spacer />
        <VersionsTable>
          {versions?.electron && (
            <tr>
        ...
        <BugReport
          href="https://github.com/HydrangeaBlockchain/hydrangea-blockchain/issues"
          target="_blank"
        >
          Report an issue
        </BugReport>
