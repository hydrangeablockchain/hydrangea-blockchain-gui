...
import { AlertDialog, Card, Flex, Loading, Dropzone } from '@hydrangea/core';
import {
...
import { mojo_to_hydrangea_string } from '../../../util/hydrangea';
  ...
  return (
    <Grid item xs={12}>
      <Box display="flex">
        ...
        <Box>
          <Typography variant="subtitle1">
            {mojo_to_hydrangea_string(props.balance)} TXHG
          </Typography>
        </Box>
      </Box>
    </Grid>
