...
import { AlertDialog } from '@hydrangea/core';
import {
  Typography,
  Button,
  Box,
...
import { hydrangea_to_mojo } from '../../../util/hydrangea';
...
export const CreateRLAdminWallet = () => {
  ...
  function create() {
    ...
    const hydrangeaper = hydrangea_to_mojo(hydrangeaper_input.value);
    ...
    // var fee = hydrangea_to_mojo(fee_input.value);
