...
import { AlertDialog, Card, Flex } from '@hydrangea/core';
...
function BalanceCard(props: BalanceCardProps) {
  ...
  const balance_ptotal_hydrangea = mojo_to_colouredcoin_string(balance_ptotal);
  const balance_pending_hydrangea = mojo_to_colouredcoin_string(balance_pending);
  const balance_change_hydrangea = mojo_to_colouredcoin_string(balance_change);
  const acc_content =
    balancebox_1 +
    balancebox_2 +
    balancebox_ptotal +
    balancebox_3 +
    balance_ptotal_hydrangea +
    balancebox_unit +
    balancebox_hline +
    balancebox_4 +
    balancebox_row +
